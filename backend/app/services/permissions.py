...
PERMISSION_CODES = [
    ...
    ("stock.item_info", "View item passport, balances, and history"),
    ("stock.item_create", "Create products and product groups"),
    ("stock.item_edit", "Edit products and product groups"),
    ("purchase.read", "View purchase documents"),
    ("purchase.write", "Create and modify purchase documents"),
    ("purchase.perform", "Perform purchase documents"),
    ("purchase.perform_cancel", "Cancel perform on purchase documents"),
    ("purchase.lock", "Lock purchase documents"),
    ("purchase.unlock", "Unlock purchase documents"),
    ("movement.read", "View stock movement documents"),
    ("movement.write", "Create and modify stock movement documents"),
    ("movement.perform", "Perform stock movement documents"),
    ("movement.perform_cancel", "Cancel perform on stock movement documents"),
    ("movement.lock", "Lock stock movement documents"),
    ("movement.unlock", "Unlock stock movement documents"),
    ("inventory.read", "View inventory documents"),
    ("inventory.write", "Count and modify inventory documents"),
    ("inventory.perform", "Close inventory documents"),
    ("inventory.perform_cancel", "Reopen inventory documents"),
    ("inventory.lock", "Lock inventory documents"),
    ("inventory.unlock", "Unlock inventory documents"),
    ("inout.read", "View stock receipt and write-off documents"),
    ("inout.write", "Create and modify stock receipt and write-off documents"),
    ("inout.perform", "Perform stock receipt and write-off documents"),
    ("inout.perform_cancel", "Cancel perform on stock receipt and write-off documents"),
    ("inout.lock", "Lock stock receipt and write-off documents"),
    ("inout.unlock", "Unlock stock receipt and write-off documents"),
    ("return_to_partner.read", "View returns to partner documents"),
    ("return_to_partner.write", "Create and modify returns to partner documents"),
    ("return_to_partner.perform", "Perform returns to partner documents"),
    ("return_to_partner.perform_cancel", "Cancel perform on returns to partner documents"),
    ("return_to_partner.lock", "Lock returns to partner documents"),
    ("return_to_partner.unlock", "Unlock returns to partner documents"),
