...
export function ReturnsDetailContent({
  document,
  operations,
  payments,
  loading = false,
  ...
  return (
    <>
      <div className={styles.detailMeta}>
        ...
        <div>
          <span className={styles.detailLabel}>{t("returns.detail.originalSale")}</span>
          <span>
        ...
        <div>
          <span className={styles.detailLabel}>{t("returns.detail.reason")}</span>
